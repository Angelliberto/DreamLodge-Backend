...
function buildUserProfileText({ o, c, e, a, n }) {
  return `ocean (medias Likert 1–5): openness ${Number(o || 0).toFixed(2)}, conscientiousness ${Number(c || 0).toFixed(2)}, extraversion ${Number(e || 0).toFixed(2)}, agreeableness ${Number(a || 0).toFixed(2)}, neuroticism ${Number(n || 0).toFixed(2)}`;
}
